package com.ewedo.facerecognition.widget;
...
import com.ewedo.facerecognition.datasource.FileMediaDataSource;
...
public class IjkVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    IMediaPlayer.OnPreparedListener mPreparedListener = new IMediaPlayer.OnPreparedListener() {
        public void onPrepared(IMediaPlayer mp) {
            ...
            if (mVideoWidth != 0 && mVideoHeight != 0) {
                ...
                // REMOVED: getHolder().setFixedSize(mVideoWidth, mVideoHeight);
                if (mRenderView != null) {
                    //trig onserfacechanged
                    mRenderView.setVideoSize(mVideoWidth, mVideoHeight);
                    mRenderView.setVideoSampleAspectRatio(mVideoSarNum, mVideoSarDen);

                    boolean c1 = !mRenderView.shouldWaitForResize();
                    boolean c2 = mSurfaceWidth == mVideoWidth;
                    boolean c3 = mSurfaceHeight == mVideoHeight;
                    if (c1 || c2 && c3) {
    ...
    private IMediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener =
            new IMediaPlayer.OnBufferingUpdateListener() {
                public void onBufferingUpdate(IMediaPlayer mp, int percent) {
                    Log.i(TAG, "onBufferingUpdate() called with: mp = [" + mp + "], percent = [" + percent + "]");
    ...
    IRenderView.IRenderCallback mSHCallback = new IRenderView.IRenderCallback() {
        ...
        public void onSurfaceChanged(@NonNull IRenderView.ISurfaceHolder holder, int format, int w, int h) {
            ...
            Log.i(TAG, "onSurfaceChanged() w = [" + w + "], h = [" + h + "]" + isValidState + "::" + hasValidSize);
